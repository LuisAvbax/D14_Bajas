 ...
 *
 */
public interface ReporteResumenAjusteService extends Serializable{
	
	public ReporteDetalladoPorTipoBean datosWhere(ReporteDetalladoPorTipoBean datos);
	public ReporteDetalladoPorTipoBean consultaResumenAjuste(ReporteDetalladoPorTipoBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException;
