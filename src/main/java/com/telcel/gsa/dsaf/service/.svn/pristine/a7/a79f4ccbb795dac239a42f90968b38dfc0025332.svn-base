...
import com.telcel.gsa.dsaf.amov.dao.ResumenConceptosAmovDao;
...
import com.telcel.gsa.dsaf.dipcel.dao.ResumenConceptosDipcelDao;
 ...
 *
 */
@Service("resumenConceptoService")
public class ResumenConceptoServiceImpl implements ResumenConceptoService, Serializable{

	
	@Autowired
	AdquisicionBajaDao adquisicionBajaDao;
	@Autowired
	ResumenConceptosDao resumenConceptosDao;
	@Autowired
	ResumenConceptosDipcelDao resumenConceptosDipcelDao;
	@Autowired
	ResumenConceptosSercotelDao resumenConceptosSercotelDao;
	@Autowired
	ResumenConceptosAmovDao resumenConceptosAmovDao;
	...
	public HSSFWorkbook generaDocumento(ResumenConceptoRegBean datos) throws IOException {
		...
		headerRow.createCell((short) 1).setCellValue( 
		new HSSFRichTextString(Constants.TIT_REP_CONCEPTO_CLASE)); 
		headerRow.getCell(1).setCellStyle(headerStyle);
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 1).setCellValue( 
		...
		headerRow.createCell((short) 1).setCellValue(" ");
		headerRow.createCell((short) 2).setCellValue( 
				datos.getTotReporteGeneral().getAdq_ac_baja() != null ? datos.getTotReporteGeneral().getAdq_baja().doubleValue():0.0);
		headerRow.createCell((short) 3).setCellValue( 
	...
	public ResumenConceptoRegBean consultaConceptoRegion(ResumenConceptoRegBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		ResumenConceptoRegBean tGlobalReg = null;
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalReg = resumenConceptosDao.consultaConceptoRegion(datos);
			}break;
			case 2:{
				tGlobalReg = resumenConceptosDipcelDao.consultaConceptoRegion(datos);
			}break;
			case 3:{
				tGlobalReg = resumenConceptosSercotelDao.consultaConceptoRegion(datos);
			}break;
			case 4:{
				tGlobalReg = resumenConceptosAmovDao.consultaConceptoRegion(datos);
			}break;
		}
	...
	public ResumenConceptoRegBean consultaConceptoNetos(ResumenConceptoRegBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
				case 1:{
					tGlobalReg = resumenConceptosDao.consultaConceptoNetos(datos);
				}break;
				case 2:{
					tGlobalReg = resumenConceptosDipcelDao.consultaConceptoNetos(datos);
				}break;
				case 3:{
					tGlobalReg = resumenConceptosSercotelDao.consultaConceptoNetos(datos);
				}break;
				case 4:{
					tGlobalReg = resumenConceptosAmovDao.consultaConceptoNetos(datos);
				}break;
			}
	...
	public ResumenConceptoRegBean consultaAjConceptoRegion(ResumenConceptoRegBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalReg = resumenConceptosDao.consultaAjConceptoRegion(datos);
			}break;
			case 2:{
				tGlobalReg = resumenConceptosDipcelDao.consultaAjConceptoRegion(datos);
			}break;
			case 3:{
				tGlobalReg = resumenConceptosSercotelDao.consultaAjConceptoRegion(datos);
			}break;
			case 4:{
				tGlobalReg = resumenConceptosAmovDao.consultaAjConceptoRegion(datos);
			}break;
		}
	...
	public ResumenConceptoClasBean consultaConceptosClase(ResumenConceptoClasBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		ResumenConceptoClasBean tGlobalReg = null;
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalReg = resumenConceptosDao.consultaConceptoClase(datos);
			}break;
			case 2:{
				tGlobalReg = resumenConceptosDipcelDao.consultaConceptoClase(datos);
			}break;
			case 3:{
				tGlobalReg = resumenConceptosSercotelDao.consultaConceptoClase(datos);
			}break;
			case 4:{
				tGlobalReg = resumenConceptosAmovDao.consultaConceptoClase(datos);
			}break;
		}
	...
	public ResumenConceptoClasBean consultaAjConceptosClase(ResumenConceptoClasBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		ResumenConceptoClasBean tGlobalClas = null;
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalClas = resumenConceptosDao.consultaAjConceptoClase(datos);
			}break;
			case 2:{
				tGlobalClas = resumenConceptosDipcelDao.consultaAjConceptoClase(datos);
			}break;
			case 3:{
				tGlobalClas = resumenConceptosSercotelDao.consultaAjConceptoClase(datos);
			}break;
			case 4:{
				tGlobalClas = resumenConceptosAmovDao.consultaAjConceptoClase(datos);
			}break;
		}
	...
	public ResumenConceptoClasBean consultaConceptosClaseNetos(ResumenConceptoClasBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalClas = resumenConceptosDao.consultaConceptoClasNetos(datos);
			}break;
			case 2:{
				tGlobalClas = resumenConceptosDipcelDao.consultaConceptoClasNetos(datos);
			}break;
			case 3:{
				tGlobalClas = resumenConceptosSercotelDao.consultaConceptoClasNetos(datos);
			}break;
			case 4:{
				tGlobalClas = resumenConceptosAmovDao.consultaConceptoClasNetos(datos);
			}break;
		}
