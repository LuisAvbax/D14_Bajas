...
import com.telcel.gsa.dsaf.amov.dao.AdquisicionBajaAmovDao;
...
import com.telcel.gsa.dsaf.dipcel.dao.AdquisicionBajaDipselDao;
import com.telcel.gsa.dsaf.dipcel.dao.InpcDipcelDao;
import com.telcel.gsa.dsaf.security.SessionScopeUser;
import com.telcel.gsa.dsaf.sercotel.dao.AdquisicionBajaSercotelDao;
 ...
 *
 */
@Service("adqBajasService")
public class AdqBajasServiceImpl implements AqdBajasService, Serializable{
	...
	@Autowired
	@Qualifier("adquisicionBajaDaoImpl")
	AdquisicionBajaDao adquisicionBajaDao;
	@Autowired
	@Qualifier("adquisicionBajaDipselDaoImpl")
	AdquisicionBajaDipselDao adquisicionBajaDipcelDao;
	@Autowired
	@Qualifier("adquisicionBajaSercotelDaoImpl")
	AdquisicionBajaSercotelDao adquisicionBajaSercotelDao;
	@Autowired
	@Qualifier("adquisicionBajaDaoAmovImpl")
	AdquisicionBajaAmovDao adquisicionBajaDaoAmovImpl;
	...
	public AdqBajasBean ConsultaReg(AdqBajasBean datos, SessionScopeUser sessionData) throws CfeException, SQLException {
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaRegion(datos);
				}break;
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaRegion(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaRegion(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaRegion(datos);
				}break;
			}
	...
	public AdqBajasBean ConsultaRegAjus(AdqBajasBean datos, SessionScopeUser sessionData) throws CfeException, SQLException {
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaRegionAjustes(datos);
				}break;
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaRegionAjustes(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaRegionAjustes(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaRegionAjustes(datos);
				}break;
			}
		}catch(CfeException e){
			throw e;
	...
	public AdqBajasBean ConsultaRegNetos(AdqBajasBean datos, SessionScopeUser sessionData) throws CfeException, SQLException {
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaRegionNetos(datos);
				}break;
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaRegionNetos(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaRegionNetos(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaRegionNetos(datos);
				}break;
			}
		}catch(CfeException e){
			throw e;
	...
	public HSSFWorkbook generaDocumento(AdqBajasBean datos) throws IOException {
		...
		headerRow.createCell((short) 2).setCellValue( 
		new HSSFRichTextString(Constants.TIT_REP_BAJ_REGION));
		headerRow.getCell(2).setCellStyle(headerStyle);
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 2).setCellValue( 
		...
		if (datos.getAjuste().getClave().equals("TA"))
		{
			rowNum++;
			headerRow = sheet.createRow((short) rowNum++); 
			headerRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_JUSTES_MOI));
	...
	public AdqBajasBean ConsultaClas(AdqBajasBean datos, SessionScopeUser sessionData) throws CfeException, SQLException {
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaClase(datos);
				}break;
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaClase(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaClase(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaClase(datos);
				}break;
			}
		}catch(CfeException e){
			throw e;
	...
	public AdqBajasBean ConsultaClasAjus(AdqBajasBean datos, SessionScopeUser sessionData) throws CfeException, SQLException {
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaClaseAjustes(datos);
				}break;
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaClaseAjustes(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaClaseAjustes(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaClaseAjustes(datos);
				}break;
			}
...
//		datos = adquisicionBajaDao.consultaClaseNetos(datos);
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaClaseNetos(datos);
				...
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaClaseNetos(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaClaseNetos(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaClaseNetos(datos);
				}break;
			}
	...
	public HSSFWorkbook generaDocumentoClas(AdqBajasBean datos) throws IOException {
		...
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 2).setCellValue( 
		new HSSFRichTextString(Constants.TIT_REP_BAJ_CLASE));
		headerRow.getCell(2).setCellStyle(headerStyle);
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 2).setCellValue( 
		new HSSFRichTextString(datos.getCalculotxt()));
		...
		HSSFRow contRow = sheet.createRow((short) rowNum++); 
		for (RepAdqClasBean datlist : datos.getListRepAdqClas()) {
			contRow = sheet.createRow((short) rowNum++); 
			contRow.createCell((short) 0).setCellValue(new HSSFRichTextString(datlist.getClase()));
			contRow.createCell((short) 1).setCellValue(datlist.getEnero() != null ? datlist.getEnero().toString():"0.00"); 
			contRow.createCell((short) 2).setCellValue(datlist.getFebrero() != null ? datlist.getFebrero().toString():"0.00");
			contRow.createCell((short) 3).setCellValue(datlist.getMarzo() != null ? datlist.getMarzo().toString():"0.00");
			contRow.createCell((short) 4).setCellValue(datlist.getAbril() != null ? datlist.getAbril().toString():"0.00");
			contRow.createCell((short) 5).setCellValue(datlist.getMayo() != null ? datlist.getMayo().toString():"0.00");
			contRow.createCell((short) 6).setCellValue(datlist.getJunio() != null ? datlist.getJunio().toString():"0.00");
			contRow.createCell((short) 7).setCellValue(datlist.getJulio() != null ? datlist.getJulio().toString():"0.00");
			contRow.createCell((short) 8).setCellValue(datlist.getAgosto() != null ? datlist.getAgosto().toString():"0.00");
			contRow.createCell((short) 9).setCellValue(datlist.getSeptiembre() != null ? datlist.getSeptiembre().toString():"0.00");
			contRow.createCell((short) 10).setCellValue(datlist.getOctubre() != null ? datlist.getOctubre().toString():"0.00");
			contRow.createCell((short) 11).setCellValue(datlist.getNoviembre() != null ? datlist.getNoviembre().toString():"0.00");
			contRow.createCell((short) 12).setCellValue(datlist.getDiciembre() != null ? datlist.getDiciembre().toString():"0.00");
			contRow.createCell((short) 13).setCellValue(datlist.getTotalClase() != null ? datlist.getTotalClase().toString():"0.00");
			contRow.getCell(0).setCellStyle(cellStyle1);
			contRow.getCell(1).setCellStyle(cellStyle);
			contRow.getCell(2).setCellStyle(cellStyle);
			contRow.getCell(3).setCellStyle(cellStyle);
			contRow.getCell(4).setCellStyle(cellStyle);
			contRow.getCell(5).setCellStyle(cellStyle);
			contRow.getCell(6).setCellStyle(cellStyle);
			contRow.getCell(7).setCellStyle(cellStyle);
			contRow.getCell(8).setCellStyle(cellStyle);
			contRow.getCell(9).setCellStyle(cellStyle);
			contRow.getCell(10).setCellStyle(cellStyle);
			contRow.getCell(11).setCellStyle(cellStyle);
			contRow.getCell(12).setCellStyle(cellStyle);
			contRow.getCell(13).setCellStyle(cellStyle);
			
			}
			
		
			contRow = sheet.createRow((short) rowNum++); 
			contRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_RE_TOTAL));
			contRow.createCell((short) 1).setCellValue(datos.getTotReporteMesGeneral().getEnero() != null ? datos.getTotReporteMesGeneral().getEnero().toString():"0.00"); 
			contRow.createCell((short) 2).setCellValue(datos.getTotReporteMesGeneral().getFebrero() != null ? datos.getTotReporteMesGeneral().getFebrero().toString():"0.00");
			contRow.createCell((short) 3).setCellValue(datos.getTotReporteMesGeneral().getMarzo() != null ? datos.getTotReporteMesGeneral().getMarzo().toString():"0.00");
			contRow.createCell((short) 4).setCellValue(datos.getTotReporteMesGeneral().getAbril() != null ? datos.getTotReporteMesGeneral().getAbril().toString():"0.00");
			contRow.createCell((short) 5).setCellValue(datos.getTotReporteMesGeneral().getMayo() != null ? datos.getTotReporteMesGeneral().getMayo().toString():"0.00");
			contRow.createCell((short) 6).setCellValue(datos.getTotReporteMesGeneral().getJunio() != null ? datos.getTotReporteMesGeneral().getJunio().toString():"0.00");
			contRow.createCell((short) 7).setCellValue(datos.getTotReporteMesGeneral().getJulio() != null ? datos.getTotReporteMesGeneral().getJulio().toString():"0.00");
			contRow.createCell((short) 8).setCellValue(datos.getTotReporteMesGeneral().getAgosto() != null ? datos.getTotReporteMesGeneral().getAgosto().toString():"0.00");
			contRow.createCell((short) 9).setCellValue(datos.getTotReporteMesGeneral().getSeptiembre() != null ? datos.getTotReporteMesGeneral().getSeptiembre().toString():"0.00");
			contRow.createCell((short) 10).setCellValue(datos.getTotReporteMesGeneral().getOctubre() != null ? datos.getTotReporteMesGeneral().getOctubre().toString():"0.00");
			contRow.createCell((short) 11).setCellValue(datos.getTotReporteMesGeneral().getNoviembre() != null ? datos.getTotReporteMesGeneral().getNoviembre().toString():"0.00");
			contRow.createCell((short) 12).setCellValue(datos.getTotReporteMesGeneral().getDiciembre() != null ? datos.getTotReporteMesGeneral().getDiciembre().toString():"0.00");
			contRow.createCell((short) 13).setCellValue(datos.getTotReporteMesGeneral().getTotal() != null ? datos.getTotReporteMesGeneral().getTotal().toString():"0.00");
		...
		if (datos.getAjuste().getClave().equals("TA"))
		{
			rowNum++;
			contRow = sheet.createRow((short) rowNum++); 
			contRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_JUSTES_MOI));
			...
			for (RepAdqClasBean datlist : datos.getListRepAjAdqClas()) {	
				...
				contRow = sheet.createRow((short) rowNum++); 
				contRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_RE_TOTAL));
				contRow.createCell((short) 1).setCellValue(datos.getTotReporteMesAjusteGeneral().getEnero() != null ? datos.getTotReporteMesAjusteGeneral().getEnero().toString():"0.00"); 
				contRow.createCell((short) 2).setCellValue(datos.getTotReporteMesAjusteGeneral().getFebrero() != null ? datos.getTotReporteMesAjusteGeneral().getFebrero().toString():"0.00");
				contRow.createCell((short) 3).setCellValue(datos.getTotReporteMesAjusteGeneral().getMarzo() != null ? datos.getTotReporteMesAjusteGeneral().getMarzo().toString():"0.00");
				contRow.createCell((short) 4).setCellValue(datos.getTotReporteMesAjusteGeneral().getAbril() != null ? datos.getTotReporteMesAjusteGeneral().getAbril().toString():"0.00");
				contRow.createCell((short) 5).setCellValue(datos.getTotReporteMesAjusteGeneral().getMayo() != null ? datos.getTotReporteMesAjusteGeneral().getMayo().toString():"0.00");
				contRow.createCell((short) 6).setCellValue(datos.getTotReporteMesAjusteGeneral().getJunio() != null ? datos.getTotReporteMesAjusteGeneral().getJunio().toString():"0.00");
				contRow.createCell((short) 7).setCellValue(datos.getTotReporteMesAjusteGeneral().getJulio() != null ? datos.getTotReporteMesAjusteGeneral().getJulio().toString():"0.00");
				contRow.createCell((short) 8).setCellValue(datos.getTotReporteMesAjusteGeneral().getAgosto() != null ? datos.getTotReporteMesAjusteGeneral().getAgosto().toString():"0.00");
				contRow.createCell((short) 9).setCellValue(datos.getTotReporteMesAjusteGeneral().getSeptiembre() != null ? datos.getTotReporteMesAjusteGeneral().getSeptiembre().toString():"0.00");
				contRow.createCell((short) 10).setCellValue(datos.getTotReporteMesAjusteGeneral().getOctubre() != null ? datos.getTotReporteMesAjusteGeneral().getOctubre().toString():"0.00");
				contRow.createCell((short) 11).setCellValue(datos.getTotReporteMesAjusteGeneral().getNoviembre() != null ? datos.getTotReporteMesAjusteGeneral().getNoviembre().toString():"0.00");
				contRow.createCell((short) 12).setCellValue(datos.getTotReporteMesAjusteGeneral().getDiciembre() != null ? datos.getTotReporteMesAjusteGeneral().getDiciembre().toString():"0.00");
				contRow.createCell((short) 13).setCellValue(datos.getTotReporteMesAjusteGeneral().getTotal() != null ? datos.getTotReporteMesAjusteGeneral().getTotal().toString():"0.00");
				contRow.getCell(0).setCellStyle(cellStyle1);
				contRow.getCell(1).setCellStyle(cellStyle);
				contRow.getCell(2).setCellStyle(cellStyle);
				contRow.getCell(3).setCellStyle(cellStyle);
				...
				rowNum++;
				contRow = sheet.createRow((short) rowNum++); 
				contRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_GRAN_TOT_AJUST));
				contRow.createCell((short) 1).setCellValue(datos.getTotReporteMesAjusteGran().getEnero() != null ? datos.getTotReporteMesAjusteGran().getEnero().toString():"0.00"); 
				contRow.createCell((short) 2).setCellValue(datos.getTotReporteMesAjusteGran().getFebrero() != null ? datos.getTotReporteMesAjusteGran().getFebrero().toString():"0.00");
				contRow.createCell((short) 3).setCellValue(datos.getTotReporteMesAjusteGran().getMarzo() != null ? datos.getTotReporteMesAjusteGran().getMarzo().toString():"0.00");
				contRow.createCell((short) 4).setCellValue(datos.getTotReporteMesAjusteGran().getAbril() != null ? datos.getTotReporteMesAjusteGran().getAbril().toString():"0.00");
				contRow.createCell((short) 5).setCellValue(datos.getTotReporteMesAjusteGran().getMayo() != null ? datos.getTotReporteMesAjusteGran().getMayo().toString():"0.00");
				contRow.createCell((short) 6).setCellValue(datos.getTotReporteMesAjusteGran().getJunio() != null ? datos.getTotReporteMesAjusteGran().getJunio().toString():"0.00");
				contRow.createCell((short) 7).setCellValue(datos.getTotReporteMesAjusteGran().getJulio() != null ? datos.getTotReporteMesAjusteGran().getJulio().toString():"0.00");
				contRow.createCell((short) 8).setCellValue(datos.getTotReporteMesAjusteGran().getAgosto() != null ? datos.getTotReporteMesAjusteGran().getAgosto().toString():"0.00");
				contRow.createCell((short) 9).setCellValue(datos.getTotReporteMesAjusteGran().getSeptiembre() != null ? datos.getTotReporteMesAjusteGran().getSeptiembre().toString():"0.00");
				contRow.createCell((short) 10).setCellValue(datos.getTotReporteMesAjusteGran().getOctubre() != null ? datos.getTotReporteMesAjusteGran().getOctubre().toString():"0.00");
				contRow.createCell((short) 11).setCellValue(datos.getTotReporteMesAjusteGran().getNoviembre() != null ? datos.getTotReporteMesAjusteGran().getNoviembre().toString():"0.00");
				contRow.createCell((short) 12).setCellValue(datos.getTotReporteMesAjusteGran().getDiciembre() != null ? datos.getTotReporteMesAjusteGran().getDiciembre().toString():"0.00");
				contRow.createCell((short) 13).setCellValue(datos.getTotReporteMesAjusteGran().getTotal() != null ? datos.getTotReporteMesAjusteGran().getTotal().toString():"0.00");
...
//		datos = adquisicionBajaDao.consultaTexto(datos);
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaTexto(datos);
				...
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaTexto(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaTexto(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaTexto(datos);
				}break;
			}
...
//		datos = adquisicionBajaDao.consultaTextoAjustes(datos);
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaTextoAjustes(datos);
				...
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaTextoAjustes(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaTextoAjustes(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaTextoAjustes(datos);
				}break;
			}
...
//		datos = adquisicionBajaDao.consultaTextoNetos(datos);
		try{
			switch(sessionData.getSociedad().getId()){
				case 1:{
					datos = adquisicionBajaDao.consultaTextoNetos(datos);
				...
				case 2:{
					datos = adquisicionBajaDipcelDao.consultaTextoNetos(datos);
				}break;
				case 3:{
					datos = adquisicionBajaSercotelDao.consultaTextoNetos(datos);
				}break;
				case 4:{
					datos = adquisicionBajaDaoAmovImpl.consultaTextoNetos(datos);
				}break;
			}
	...
	public HSSFWorkbook generaDocumentoText(AdqBajasBean datos) throws IOException {
		...
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 2).setCellValue( 
		new HSSFRichTextString(Constants.TIT_REP_BAJ_TEXTO));
		headerRow.getCell(2).setCellStyle(headerStyle);
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 2).setCellValue( 
		new HSSFRichTextString(datos.getCalculotxt()));
		...
		if (datos.getAjuste().getClave().equals("TA"))
		{
			...
			for (RepAdqTextoBean datlist : datos.getListRepAjAdqTxt()) {
				...
				headerRow.getCell(1).setCellStyle(cellStyle1);
				headerRow.getCell(2).setCellStyle(cellStyle);
				headerRow.getCell(3).setCellStyle(cellStyle);
				headerRow.getCell(4).setCellStyle(cellStyle);
				headerRow.getCell(5).setCellStyle(cellStyle);
