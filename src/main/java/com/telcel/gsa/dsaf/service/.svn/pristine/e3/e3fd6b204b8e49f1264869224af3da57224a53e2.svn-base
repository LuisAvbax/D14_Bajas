...
import com.telcel.gsa.dsaf.amov.dao.TotalGlobalAmovDao;
...
import com.telcel.gsa.dsaf.dipcel.dao.TotalGlobalDipcelDao;
import com.telcel.gsa.dsaf.security.SessionScopeUser;
import com.telcel.gsa.dsaf.sercotel.dao.TotalGlobalSercotelDao;
 ...
 *
 */
@Service("tGlobalService")
public class TotalGlobalServiceImpl implements TotalGlobalService, Serializable{

	
	@Autowired
	AdquisicionBajaDao adquisicionBajaDao;
	@Autowired
	TotalGlobalDao totalGlobalDao;
	@Autowired
	TotalGlobalAmovDao totalGlobalAmovDao;
	@Autowired
	TotalGlobalDipcelDao totalGlobalDipcelDao;
	@Autowired
	TotalGlobalSercotelDao totalGlobalSercotelDao;
	/**
	 * 
	 */
	...
	public HSSFWorkbook generaDocumento(TotalGlobalRegBean datos) throws IOException {
		...
		headerRow.createCell((short) 1).setCellValue( 
		new HSSFRichTextString(Constants.TIT_REP_GLOB_REGION)); 
		headerRow.getCell(1).setCellStyle(headerStyle);
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 1).setCellValue( 
		...
		headerRow.createCell((short) 1).setCellValue( 
				new HSSFRichTextString("ADQUISICION BAJA "));
		headerRow.createCell((short) 2).setCellValue( 
				new HSSFRichTextString("ACUMULADA BAJA "));
		headerRow.createCell((short) 3).setCellValue( 
				new HSSFRichTextString("EJERCICIO BAJA "));
		headerRow.createCell((short) 4).setCellValue( 
				new HSSFRichTextString("DEPRECIACION TOTAL "));
		headerRow.createCell((short) 5).setCellValue( 
				new HSSFRichTextString("COSTO HISTORICO "));
		headerRow.createCell((short) 6).setCellValue( 
				new HSSFRichTextString("COSTO ACTUALIZADO "));
		headerRow.createCell((short) 7).setCellValue( 
				new HSSFRichTextString("DEP. AÑO ACTUALIZADA "));
		...
		for(TGRegionBean region: datos.getDetRegiones()){
			...
			for(TGClaseBean clase: region.getClases()){
				...
				headerRow = sheet.createRow((short) rowNum++);
				headerRow.createCell((short) 0).setCellValue( 
						new HSSFRichTextString("TOTAL CLASE: " + clase.getNombre()));
				headerRow.createCell((short) 1).setCellValue( 
		...
		if (datos.getAjuste().getClave().equals("TA"))
		{
			...
			for (BajasDosBean datlist : datos.getListTotalGlobalAjReg()) {
				...
				headerRow.createCell((short) 1).setCellValue(datlist.getAdq_baja() != null ? datlist.getAdq_baja().doubleValue():0.0);
				headerRow.createCell((short) 2).setCellValue(datlist.getAdq_ac_baja() != null ? datlist.getAdq_ac_baja().doubleValue():0.0);
				headerRow.createCell((short) 3).setCellValue(datlist.getEjercicio_baja() != null ? datlist.getEjercicio_baja().doubleValue():0.0);
				headerRow.createCell((short) 4).setCellValue(datlist.getDepr_tot() != null ? datlist.getDepr_tot().doubleValue():0.0);
				headerRow.createCell((short) 5).setCellValue(datlist.getCosto_h() != null ? datlist.getCosto_h().doubleValue():0.0);
				headerRow.createCell((short) 6).setCellValue(datlist.getCosto_act() != null ? datlist.getCosto_act().doubleValue():0.0);
				headerRow.createCell((short) 7).setCellValue(datlist.getDepre_anual_act() != null ? datlist.getDepre_anual_act().doubleValue():0.0);
				headerRow.getCell(1).setCellStyle(cellStyle);	        	
				headerRow.getCell(2).setCellStyle(cellStyle);	        	
				headerRow.getCell(3).setCellStyle(cellStyle);	        	
				headerRow.getCell(4).setCellStyle(cellStyle);	        	
				...
				headerRow.createCell((short) 1).setCellValue(datos.getTotReporteAjGeneral().getAdq_baja() != null ? datos.getTotReporteAjGeneral().getAdq_baja().doubleValue():0.0); 
				headerRow.createCell((short) 2).setCellValue(datos.getTotReporteAjGeneral().getAdq_ac_baja() != null ? datos.getTotReporteAjGeneral().getAdq_ac_baja().doubleValue():0.0);
				headerRow.createCell((short) 3).setCellValue(datos.getTotReporteAjGeneral().getEjercicio_baja() != null ? datos.getTotReporteAjGeneral().getEjercicio_baja().doubleValue():0.0);
				headerRow.createCell((short) 4).setCellValue(datos.getTotReporteAjGeneral().getDepr_tot() != null ? datos.getTotReporteAjGeneral().getDepr_tot().doubleValue():0.0);
				headerRow.createCell((short) 5).setCellValue(datos.getTotReporteAjGeneral().getCosto_h() != null ? datos.getTotReporteAjGeneral().getCosto_h().doubleValue():0.0);
				headerRow.createCell((short) 6).setCellValue(datos.getTotReporteAjGeneral().getCosto_act() != null ? datos.getTotReporteAjGeneral().getCosto_act().doubleValue():0.0);
				headerRow.createCell((short) 7).setCellValue(datos.getTotReporteAjGeneral().getDepre_anual_act() != null ? datos.getTotReporteAjGeneral().getDepre_anual_act().doubleValue():0.0);
				headerRow.getCell(1).setCellStyle(cellStyle);	        	
				headerRow.getCell(2).setCellStyle(cellStyle);	        	
				headerRow.getCell(3).setCellStyle(cellStyle);	        	
				headerRow.getCell(4).setCellStyle(cellStyle);	        	
				...
				headerRow.createCell((short) 1).setCellValue(datos.getTotalGlobalRegTot().getAdq_baja() != null ? datos.getTotalGlobalRegTot().getAdq_baja().doubleValue():0.0); 
				headerRow.createCell((short) 2).setCellValue(datos.getTotalGlobalRegTot().getAdq_ac_baja() != null ? datos.getTotalGlobalRegTot().getAdq_ac_baja().doubleValue():0.0);
				headerRow.createCell((short) 3).setCellValue(datos.getTotalGlobalRegTot().getEjercicio_baja() != null ? datos.getTotalGlobalRegTot().getEjercicio_baja().doubleValue():0.0);
				headerRow.createCell((short) 4).setCellValue(datos.getTotalGlobalRegTot().getDepr_tot() != null ? datos.getTotalGlobalRegTot().getDepr_tot().doubleValue():0.0);
				headerRow.createCell((short) 5).setCellValue(datos.getTotalGlobalRegTot().getCosto_h() != null ? datos.getTotalGlobalRegTot().getCosto_h().doubleValue():0.0);
				headerRow.createCell((short) 6).setCellValue(datos.getTotalGlobalRegTot().getCosto_act() != null ? datos.getTotalGlobalRegTot().getCosto_act().doubleValue():0.0);
				headerRow.createCell((short) 7).setCellValue(datos.getTotalGlobalRegTot().getDepre_anual_act() != null ? datos.getTotalGlobalRegTot().getDepre_anual_act().doubleValue():0.0);
				headerRow.getCell(1).setCellStyle(cellStyle);	        	
				headerRow.getCell(2).setCellStyle(cellStyle);	        	
				headerRow.getCell(3).setCellStyle(cellStyle);	        	
				headerRow.getCell(4).setCellStyle(cellStyle);	        	
	...
	public TotalGlobalRegBean consultaTotalGlobalRegion(TotalGlobalRegBean datos, SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		TotalGlobalRegBean tGlobalReg = null;
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
					tGlobalReg = totalGlobalDao.consultaTotalGlobalRegion(datos);
				}break;
				case 2:{
					tGlobalReg = totalGlobalDipcelDao.consultaTotalGlobalRegion(datos);
				}break;
				case 3:{
					tGlobalReg = totalGlobalSercotelDao.consultaTotalGlobalRegion(datos);
				}break;
				case 4:{
					tGlobalReg = totalGlobalAmovDao.consultaTotalGlobalRegion(datos);
				}break;
			}
	...
	public TotalGlobalRegBean consultaTGlobalRegNetos(TotalGlobalRegBean datos,SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
				case 1:{
					tGlobalReg = totalGlobalDao.consultaTGlobalRegNetos(datos);
				}break;
				case 2:{
					tGlobalReg = totalGlobalDipcelDao.consultaTGlobalRegNetos(datos);
				}break;
				case 3:{
					tGlobalReg = totalGlobalSercotelDao.consultaTGlobalRegNetos(datos);
				}break;
				case 4:{
					tGlobalReg = totalGlobalAmovDao.consultaTGlobalRegNetos(datos);
				}break;
			}
	...
	public TotalGlobalRegBean consultaAjTotalGlobalRegion(TotalGlobalRegBean datos,SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalReg = totalGlobalDao.consultaAjTotalGlobalRegion(datos);
			}break;
			case 2:{
				tGlobalReg = totalGlobalDipcelDao.consultaAjTotalGlobalRegion(datos);
			}break;
			case 3:{
				tGlobalReg = totalGlobalSercotelDao.consultaAjTotalGlobalRegion(datos);
			}break;
			case 4:{
				tGlobalReg = totalGlobalAmovDao.consultaAjTotalGlobalRegion(datos);
			}break;
		}
	...
	public TotalGlobalClaBean consultaTotalGlobalClase(TotalGlobalClaBean datos,SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		TotalGlobalClaBean tGlobalClase = null;
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalClase = totalGlobalDao.consultaTotalGlobalClase(datos);
			}break;
			case 2:{
				tGlobalClase = totalGlobalDipcelDao.consultaTotalGlobalClase(datos);
			}break;
			case 3:{
				tGlobalClase = totalGlobalSercotelDao.consultaTotalGlobalClase(datos);
			}break;
			case 4:{
				tGlobalClase = totalGlobalAmovDao.consultaTotalGlobalClase(datos);
			}break;
		}
	...
	public TotalGlobalClaBean consultaTGlobalClaNetos(TotalGlobalClaBean datos,SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalClase = totalGlobalDao.consultaTGlobalClaNetos(datos);
			}break;
			case 2:{
				tGlobalClase = totalGlobalDipcelDao.consultaTGlobalClaNetos(datos);
			}break;
			case 3:{
				tGlobalClase = totalGlobalSercotelDao.consultaTGlobalClaNetos(datos);
			}break;
			case 4:{
				tGlobalClase = totalGlobalAmovDao.consultaTGlobalClaNetos(datos);
			}break;
		}
	...
	public TotalGlobalClaBean consultaAjTotalGlobalClase(TotalGlobalClaBean datos,SessionScopeUser sessionScopeUser) throws CfeException, SQLException{
		...
		try{
			switch(sessionScopeUser.getSociedad().getId()){
			case 1:{
				tGlobalClase = totalGlobalDao.consultaAjTotalGlobalClase(datos);
			}break;
			case 2:{
				tGlobalClase = totalGlobalDipcelDao.consultaAjTotalGlobalClase(datos);
			}break;
			case 3:{
				tGlobalClase = totalGlobalSercotelDao.consultaAjTotalGlobalClase(datos);
			}break;
			case 4:{
				tGlobalClase = totalGlobalAmovDao.consultaAjTotalGlobalClase(datos);
			}break;
		}
	...
	public HSSFWorkbook generaDocumentoClase(TotalGlobalClaBean datos) throws IOException {
		...
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 1).setCellValue( 
		new HSSFRichTextString(Constants.TIT_REP_GLOB_CLASE)); 
		headerRow.getCell(1).setCellStyle(headerStyle);
		headerRow = sheet.createRow((short) rowNum++); 
		headerRow.createCell((short) 1).setCellValue( 
		new HSSFRichTextString(datos.getCalculotxt())); 
		...
		if (datos.getAjuste().getClave().equals("TA"))
		{
			...
			for (BajasDosBean datlist : datos.getListTotalGlobalAjCla()) {
				...
				headerRow = sheet.createRow((short) rowNum++); 
				headerRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_RE_TOTAL_AJU_TPO));
				headerRow.createCell((short) 1).setCellValue(datos.getTotReporteAjGeneral().getAdq_baja() != null ? datos.getTotReporteAjGeneral().getAdq_baja().doubleValue():0.0); 
				headerRow.createCell((short) 2).setCellValue(datos.getTotReporteAjGeneral().getAdq_ac_baja() != null ? datos.getTotReporteAjGeneral().getAdq_ac_baja().doubleValue():0.0);
				headerRow.createCell((short) 3).setCellValue(datos.getTotReporteAjGeneral().getEjercicio_baja() != null ? datos.getTotReporteAjGeneral().getEjercicio_baja().doubleValue():0.0);
				headerRow.createCell((short) 4).setCellValue(datos.getTotReporteAjGeneral().getDepr_tot() != null ? datos.getTotReporteAjGeneral().getDepr_tot().doubleValue():0.0);
				...
				headerRow = sheet.createRow((short) rowNum++); 
				headerRow.createCell((short) 0).setCellValue(new HSSFRichTextString(Constants.TIT_GRAN_TOT_AJUST));
				headerRow.createCell((short) 1).setCellValue(datos.getTotalGlobalClaTot().getAdq_baja() != null ? datos.getTotalGlobalClaTot().getAdq_baja().doubleValue():0.0); 
				headerRow.createCell((short) 2).setCellValue(datos.getTotalGlobalClaTot().getAdq_ac_baja() != null ? datos.getTotalGlobalClaTot().getAdq_ac_baja().doubleValue():0.0);
				headerRow.createCell((short) 3).setCellValue(datos.getTotalGlobalClaTot().getEjercicio_baja() != null ? datos.getTotalGlobalClaTot().getEjercicio_baja().doubleValue():0.0);
				headerRow.createCell((short) 4).setCellValue(datos.getTotalGlobalClaTot().getDepr_tot() != null ? datos.getTotalGlobalClaTot().getDepr_tot().doubleValue():0.0);
				headerRow.createCell((short) 5).setCellValue(datos.getTotalGlobalClaTot().getCosto_h() != null ? datos.getTotalGlobalClaTot().getCosto_h().doubleValue():0.0);
				headerRow.createCell((short) 6).setCellValue(datos.getTotalGlobalClaTot().getCosto_act() != null ? datos.getTotalGlobalClaTot().getCosto_act().doubleValue():0.0);
				headerRow.createCell((short) 7).setCellValue(datos.getTotalGlobalClaTot().getDepre_anual_act() != null ? datos.getTotalGlobalClaTot().getDepre_anual_act().doubleValue():0.0);
				headerRow.getCell(1).setCellStyle(cellStyle);	        	
				headerRow.getCell(2).setCellStyle(cellStyle);	        	
				headerRow.getCell(3).setCellStyle(cellStyle);	        	
				headerRow.getCell(4).setCellStyle(cellStyle);	        	
