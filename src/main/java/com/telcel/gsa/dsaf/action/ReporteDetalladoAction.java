 ...
 *
 */
@Service("repDetalladoAct")
@ViewScoped
public class ReporteDetalladoAction implements Serializable{

	private static final long serialVersionUID = 1357848192092043408L;

	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoAction.class);
	...
	@Autowired
	private ReporteDetalladoService reporteDetalladoService;
	@Autowired
	...
	public void consulta(RequestContext ctx) throws CfeException, SQLException{
		...
		reporteDetallado = reporteDetalladoService.datosWhere(reporteDetallado);
		...
		{							   
			...
			reporteDetallado = reporteDetalladoService.consultaReporteDetallado(reporteDetallado,sessionScopeUser);
		}
		if (reporteDetallado.getAjuste() != null && reporteDetallado.getAjuste().getClave().equals("TA"))
		{
			...
			reporteDetallado = reporteDetalladoService.consultaAjReporteDetallado(reporteDetallado,sessionScopeUser);
		}
		if (reporteDetallado.getAjuste() != null && reporteDetallado.getAjuste().getClave().equals("N"))
		{
			...
			reporteDetallado = reporteDetalladoService.consultaReporteDetalladoNetos(reporteDetallado,sessionScopeUser);
		}
	...
	public void descarga(RequestContext ctx){
		...
		try {
			HSSFWorkbook workbook = reporteDetalladoService.generaDocumento(reporteDetallado);
