...
@Repository
public class InpcSercotelDaoImpl extends AbstractDaoImpl<BajasInpc, Integer> implements InpcSercotelDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(InpcSercotelDaoImpl.class);
	@Autowired
