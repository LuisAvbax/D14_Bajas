 ...
 */
@Repository
public class UtileriasCfeSercotelDaoImpl extends AbstractDaoImpl<BajasCatParametros, Integer> implements UtileriasCfeDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(UtileriasCfeSercotelDaoImpl.class);
	
	@Autowired
	transient DataSource dataSourceSercotel;
	
	
	protected UtileriasCfeSercotelDaoImpl() {
