...
@Repository
public class InstitucionalSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements InstitucionalSercotelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(InstitucionalSercotelDaoImpl.class);
	@Autowired
	...
	public InstitucionalSercotelDaoImpl(){
