...
@Repository
public class CostoActSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements CostoActSercotelDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(CostoActSercotelDaoImpl.class);
	@Autowired
	...
	public CostoActSercotelDaoImpl(){
