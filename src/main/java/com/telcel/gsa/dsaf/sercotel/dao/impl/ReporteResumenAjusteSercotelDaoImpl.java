...
@Repository
public class ReporteResumenAjusteSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteResumenAjusteSercotelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteResumenAjusteSercotelDaoImpl.class);
	@Autowired
	...
	public ReporteResumenAjusteSercotelDaoImpl(){
