...
@Repository
public class TcddParametroSercotelDaoImpl extends AbstractDaoImpl<TcddParametro, String> implements TccddParametroSercotelDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(TcddParametroSercotelDaoImpl.class);
	@Autowired
	 ...
	 * 
	 */
	public TcddParametroSercotelDaoImpl(){
