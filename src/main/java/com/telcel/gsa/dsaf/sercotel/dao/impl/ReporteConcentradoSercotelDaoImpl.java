...
@Repository
public class ReporteConcentradoSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteConcentradoSercotelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteConcentradoSercotelDaoImpl.class);
	@Autowired
	...
	public ReporteConcentradoSercotelDaoImpl(){
