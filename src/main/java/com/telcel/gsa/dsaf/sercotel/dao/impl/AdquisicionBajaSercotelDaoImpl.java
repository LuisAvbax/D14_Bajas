...
@Repository
public class AdquisicionBajaSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements AdquisicionBajaSercotelDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(AdquisicionBajaSercotelDaoImpl.class);
	@Autowired
	...
	public AdquisicionBajaSercotelDaoImpl(){
