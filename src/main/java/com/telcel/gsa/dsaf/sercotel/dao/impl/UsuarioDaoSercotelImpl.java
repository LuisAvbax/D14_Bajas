...
@Repository
public class UsuarioDaoSercotelImpl extends AbstractDaoImpl<BajasOpUsuario, Integer> implements UsuarioDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(UsuarioDaoSercotelImpl.class);
	@Autowired
