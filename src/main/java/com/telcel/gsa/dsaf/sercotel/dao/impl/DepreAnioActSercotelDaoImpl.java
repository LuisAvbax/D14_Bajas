...
@Repository
public class DepreAnioActSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements DepreAnioActSercotelDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(DepreAnioActSercotelDaoImpl.class);
	@Autowired
	...
	public DepreAnioActSercotelDaoImpl(){
