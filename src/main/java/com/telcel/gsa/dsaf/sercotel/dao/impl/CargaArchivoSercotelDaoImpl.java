...
@Repository
public class CargaArchivoSercotelDaoImpl extends AbstractDaoImpl<BajasBitacora, Integer> implements CargaArchivoSercotelDao, Serializable{
	...
	private static Logger logger = LoggerFactory.getLogger(CargaArchivoSercotelDaoImpl.class);
	

	public CargaArchivoSercotelDaoImpl(){
	...
	try {
		 ...
		 conn = (CallableStatement) dataSourceSercotel.getConnection().prepareCall(sqlQry);
