...
@Repository
public class ReporteDetalladoSercotelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteDetalladoSercotelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoSercotelDaoImpl.class);
	@Autowired
	...
	public ReporteDetalladoSercotelDaoImpl(){
