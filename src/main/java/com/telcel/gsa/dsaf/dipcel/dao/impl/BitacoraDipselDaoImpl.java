...
@Repository
public class BitacoraDipselDaoImpl extends AbstractDaoImpl<BajasBitacora, Integer> implements BitacoraDipselDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(BitacoraDipselDaoImpl.class);
	@Autowired
	transient DataSource dataSourceDipcel;

	public BitacoraDipselDaoImpl(){
