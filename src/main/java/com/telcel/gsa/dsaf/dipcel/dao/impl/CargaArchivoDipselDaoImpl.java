...
@Repository
public class CargaArchivoDipselDaoImpl extends AbstractDaoImpl<BajasBitacora, Integer> implements CargaArchivoDipselDao, Serializable{
	...
	private static Logger logger = LoggerFactory.getLogger(CargaArchivoDipselDaoImpl.class);
	

	public CargaArchivoDipselDaoImpl(){
	...
	try {
		 ...
		 conn = (CallableStatement) dataSourceDipcel.getConnection().prepareCall(sqlQry);
