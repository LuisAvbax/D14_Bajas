...
@Repository
public class ResumenConceptosDipcelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ResumenConceptosDipcelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ResumenConceptosDipcelDaoImpl.class);
	@Autowired
	...
	public ResumenConceptosDipcelDaoImpl(){
