...
@Repository
public class ReporteDetalladoAjusteTipoDipselDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteDetalladoAjusteTipoDipselDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoAjusteTipoDipselDaoImpl.class);
	@Autowired
	...
	public ReporteDetalladoAjusteTipoDipselDaoImpl(){
