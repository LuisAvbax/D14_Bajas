...
@Repository
public class CostoActDipselDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements CostoActDipselDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(CostoActDipselDaoImpl.class);
	@Autowired
