...
@Repository
public class InstitucionalDipcelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements InstitucionalDipcelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(InstitucionalDipcelDaoImpl.class);
	@Autowired
	...
	public InstitucionalDipcelDaoImpl(){
