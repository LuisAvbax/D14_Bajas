...
@Repository
public class TcddParametroDipselDaoImpl extends AbstractDaoImpl<TcddParametro, String> implements TccddParametroDipselDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(TcddParametroDipselDaoImpl.class);
	@Autowired
	 ...
	 * 
	 */
	public TcddParametroDipselDaoImpl(){
