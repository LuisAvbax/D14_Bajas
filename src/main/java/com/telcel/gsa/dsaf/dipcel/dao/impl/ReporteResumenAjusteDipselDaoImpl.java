...
@Repository
public class ReporteResumenAjusteDipselDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteResumenAjusteDipselDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteResumenAjusteDipselDaoImpl.class);
	@Autowired
	...
	public ReporteResumenAjusteDipselDaoImpl(){
