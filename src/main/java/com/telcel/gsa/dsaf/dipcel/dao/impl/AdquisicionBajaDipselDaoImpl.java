...
@Repository
public class AdquisicionBajaDipselDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements AdquisicionBajaDipselDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(AdquisicionBajaDipselDaoImpl.class);
	@Autowired
	...
	public AdquisicionBajaDipselDaoImpl(){
