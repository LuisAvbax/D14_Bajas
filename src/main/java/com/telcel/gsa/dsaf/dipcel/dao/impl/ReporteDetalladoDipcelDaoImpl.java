...
@Repository
public class ReporteDetalladoDipcelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteDetalladoDipcelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoDipcelDaoImpl.class);
	@Autowired
	...
	public ReporteDetalladoDipcelDaoImpl(){
