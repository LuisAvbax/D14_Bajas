...
@Repository
public class TotalGlobalDipcelDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements TotalGlobalDipcelDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(TotalGlobalDipcelDaoImpl.class);
	@Autowired
	...
	public TotalGlobalDipcelDaoImpl(){
