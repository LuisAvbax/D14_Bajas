...
@Repository
public class InpcDipcelDaoImpl extends AbstractDaoImpl<BajasInpc, Integer> implements InpcDipcelDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(InpcDipcelDaoImpl.class);
	@Autowired
