...
@Repository
public class DepreAnioActDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements DepreAnioActDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(DepreAnioActDaoImpl.class);
	@Autowired
