...
@Repository
public class UsuarioDaoImpl extends AbstractDaoImpl<BajasOpUsuario, Integer> implements UsuarioDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(UsuarioDaoImpl.class);
	@Autowired
	...
	public void actualizaUsuario(BajasOpUsuarioBean usuario) throws CfeException{
		...
		PreparedStatement preparedStatement = null;
		  try {
			...
			preparedStatement.setString(5, usuario.getApaterno());
			preparedStatement.setString(6, usuario.getAmaterno());
			preparedStatement.setInt(7,usuario.getUsuarioCreacion());
			preparedStatement.setInt(8,usuario.getUsuarioModificacion());
			preparedStatement.setInt(9,usuario.getEstadoRegistro() == true? 1:0);
