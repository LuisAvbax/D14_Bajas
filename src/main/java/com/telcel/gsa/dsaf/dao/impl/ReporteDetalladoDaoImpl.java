...
@Repository
public class ReporteDetalladoDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteDetalladoDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoDaoImpl.class);
	@Autowired
	...
	public ReporteDetalladoDaoImpl(){
