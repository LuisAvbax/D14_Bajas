...
@Repository
public class InstitucionalAjustesDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements InstitucionalAjustesDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(InstitucionalAjustesDaoImpl.class);
	@Autowired
	...
	public InstitucionalAjustesDaoImpl(){
	...
	try{
		...
		StringBuffer selectSQL = new StringBuffer("select clase||'-'||clase_dsc clase_dsc,texto_baja,region,region_dsc, "
			...
			while (rs.next()) {
				...
				System.out.println("REGISTRO$$$" + reporte.getClase()+" | "+ reporte.getTexto_baja()+" | "+ reporte.getRegion()+" | "+ reporte.getAdq_baja() + " | " + reporte.getCosto_act() + " | " + reporte.getDepre_anual_act());
