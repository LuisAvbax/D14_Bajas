...
@Repository
public class BitacoraDaoImpl extends AbstractDaoImpl<BajasBitacora, Integer> implements BitacoraDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(BitacoraDaoImpl.class);
