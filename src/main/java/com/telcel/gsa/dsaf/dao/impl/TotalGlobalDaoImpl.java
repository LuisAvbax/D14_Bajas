...
@Repository
public class TotalGlobalDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements TotalGlobalDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(TotalGlobalDaoImpl.class);
	@Autowired
