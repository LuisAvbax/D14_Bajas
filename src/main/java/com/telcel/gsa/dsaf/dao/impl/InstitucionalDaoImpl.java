...
@Repository
public class InstitucionalDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements InstitucionalDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(InstitucionalDaoImpl.class);
	/**
	 * 
	 */
