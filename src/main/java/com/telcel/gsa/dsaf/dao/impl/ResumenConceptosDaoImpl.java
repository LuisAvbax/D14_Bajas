...
@Repository
public class ResumenConceptosDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ResumenConceptosDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ResumenConceptosDaoImpl.class);
	@Autowired
	...
	public ResumenConceptosDaoImpl(){
