...
@Repository
public class ReporteConcentradoDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteConcentradoDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteConcentradoDaoImpl.class);
	...
	public ReporteConcentradoDaoImpl(){
