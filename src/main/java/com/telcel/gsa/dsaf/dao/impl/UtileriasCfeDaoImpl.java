...
import com.telcel.gsa.dsaf.bean.BajasTxtBean;
 ...
 */
@Repository
public class UtileriasCfeDaoImpl extends AbstractDaoImpl<BajasCatParametros, Integer> implements UtileriasCfeDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(UtileriasCfeDaoImpl.class);
	
	@Autowired
	transient DataSource dataSource;
	
	
	protected UtileriasCfeDaoImpl() {
...
//            		adqreg.region.id
            	...
            	selectSQL.append("order by 1 asc ");
            	System.out.println(">>> SQL GETTXT: " + selectSQL); 		         			
                PreparedStatement preparedStatement = conn.prepareStatement(selectSQL.toString());
...
public  TotalBean totalesMes (ReporteBean datos, TotalBean datMes)throws CfeException{
			...
			datMes.setTotal(datMes.getTotal() == null ? BigDecimal.ZERO : datMes.getTotal());
			return datMes;
		}
