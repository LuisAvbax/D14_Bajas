...
@Repository
public class ReporteDetalladoAjusteTipoDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteDetalladoAjusteTipoDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoAjusteTipoDaoImpl.class);
	@Autowired
	...
	public ReporteDetalladoAjusteTipoDaoImpl(){
