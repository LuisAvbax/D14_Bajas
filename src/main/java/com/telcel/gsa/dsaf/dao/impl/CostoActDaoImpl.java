...
@Repository
public class CostoActDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements CostoActDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(CostoActDaoImpl.class);
	@Autowired
