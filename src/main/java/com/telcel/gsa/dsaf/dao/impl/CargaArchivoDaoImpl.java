...
@Repository
public class CargaArchivoDaoImpl extends AbstractDaoImpl<BajasBitacora, Integer> implements CargaArchivoDao, Serializable{
	...
	private static Logger logger = LoggerFactory.getLogger(CargaArchivoDaoImpl.class);
	

	public CargaArchivoDaoImpl(){
