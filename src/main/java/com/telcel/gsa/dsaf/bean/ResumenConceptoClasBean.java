...
public class ResumenConceptoClasBean implements java.io.Serializable {
	...
	private List<BajasDosBean> listTotalGlobalClaTot;
	
	private List<BajasDosBean> listTotalGlobalCla;
	private List<TGClaseBean> detClases;
	//Listas de ajustes
	private List<BajasDosBean> listTotalGlobalAjCla;
	private TotalBajasDosBean totReporteAjGeneral;
	//TOTALES
	private TotalBajasDosBean totalGlobalClaTot;
	
	private List<TotalBajasDosBean> listTotalGlobalAjClaTot;
	...
	private List<BajasDosBean> listReporte;//reportes de pdf
	...
	public List<TGClaseBean> getDetClases() {
		return detClases;
	}
	public void setDetClases(List<TGClaseBean> detClases) {
	...
	public List<BajasDosBean> getListTotalGlobalClaTot() {
		return listTotalGlobalClaTot;
	}
	public void setListTotalGlobalClaTot(List<BajasDosBean> listTotalGlobalClaTot) {
		this.listTotalGlobalClaTot = listTotalGlobalClaTot;
	}
	public List<BajasDosBean> getListTotalGlobalCla() {
		return listTotalGlobalCla;
	}
	public void setListTotalGlobalCla(List<BajasDosBean> listTotalGlobalCla) {
		this.listTotalGlobalCla = listTotalGlobalCla;
	}
	public List<BajasDosBean> getListTotalGlobalAjCla() {
		return listTotalGlobalAjCla;
	}
	public void setListTotalGlobalAjCla(List<BajasDosBean> listTotalGlobalAjCla) {
		this.listTotalGlobalAjCla = listTotalGlobalAjCla;
	}
	public TotalBajasDosBean getTotalGlobalClaTot() {
		return totalGlobalClaTot;
	}
	public void setTotalGlobalClaTot(TotalBajasDosBean totalGlobalClaTot) {
		this.totalGlobalClaTot = totalGlobalClaTot;
	}
	public List<TotalBajasDosBean> getListTotalGlobalAjClaTot() {
		return listTotalGlobalAjClaTot;
	}
	public void setListTotalGlobalAjClaTot(List<TotalBajasDosBean> listTotalGlobalAjClaTot) {
		this.listTotalGlobalAjClaTot = listTotalGlobalAjClaTot;
	}
