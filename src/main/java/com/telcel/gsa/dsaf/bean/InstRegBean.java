...
public class InstRegBean implements java.io.Serializable {
	...
	private List<BajasDosBean> listInstRegTot;
	
	private List<BajasDosBean> listInstReg;
	...
	public List<BajasDosBean> getListInstRegTot() {
		return listInstRegTot;
	}
	public void setListInstRegTot(List<BajasDosBean> listInstRegTot) {
		this.listInstRegTot = listInstRegTot;
	}
	public List<BajasDosBean> getListInstReg() {
		return listInstReg;
	}
	public void setListInstReg(List<BajasDosBean> listInstReg) {
		this.listInstReg = listInstReg;
	}
