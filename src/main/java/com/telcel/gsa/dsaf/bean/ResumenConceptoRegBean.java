...
public class ResumenConceptoRegBean implements java.io.Serializable {
	...
	private List<BajasDosBean> listTotalGlobalRegTot;
	...
	public List<BajasDosBean> getListTotalGlobalRegTot() {
		return listTotalGlobalRegTot;
	}
	public void setListTotalGlobalRegTot(List<BajasDosBean> listTotalGlobalRegTot) {
		this.listTotalGlobalRegTot = listTotalGlobalRegTot;
	}
