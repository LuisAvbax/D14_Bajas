...
public class InstClaBean implements java.io.Serializable {
	...
	private List<BajasDosBean> listInstClaTot;
	
	private List<BajasDosBean> listInstCla;
	...
	public List<BajasDosBean> getListInstClaTot() {
		return listInstClaTot;
	}
	public void setListInstClaTot(List<BajasDosBean> listInstClaTot) {
		this.listInstClaTot = listInstClaTot;
	}
	public List<BajasDosBean> getListInstCla() {
		return listInstCla;
	}
	public void setListInstCla(List<BajasDosBean> listInstCla) {
		this.listInstCla = listInstCla;
	}
