 ...
 */
@Repository
public class UtileriasCfeAmovDaoImpl extends AbstractDaoImpl<BajasCatParametros, Integer> implements UtileriasCfeDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(UtileriasCfeAmovDaoImpl.class);
	@Autowired
	transient DataSource dataSourceAmov;
	
	
	protected UtileriasCfeAmovDaoImpl() {
