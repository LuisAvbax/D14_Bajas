...
@Repository
public class ReporteDetalladoAjusteTipoAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteDetalladoAjusteTipoAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteDetalladoAjusteTipoAmovDaoImpl.class);
	@Autowired
	...
	public ReporteDetalladoAjusteTipoAmovDaoImpl(){
