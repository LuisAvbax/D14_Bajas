...
@Repository
public class ReporteConcentradoAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteConcentradoAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteConcentradoAmovDaoImpl.class);
	@Autowired
	...
	public ReporteConcentradoAmovDaoImpl(){
