...
@Repository
public class ReporteResumenAjusteAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ReporteResumenAjusteAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ReporteResumenAjusteAmovDaoImpl.class);
	@Autowired
	...
	public ReporteResumenAjusteAmovDaoImpl(){
