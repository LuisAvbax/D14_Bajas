...
@Repository
public class ReporteCienDepreciadosAmovDaoImpl extends AbstractDaoImpl<BajasDepreciadosCien, Integer>
		implements ReporteCienDepreciadosAmovDao, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8196386119784484857L;
	final static Logger logger = LoggerFactory.getLogger(ReporteCienDepreciadosAmovDaoImpl.class);
	@Autowired
	transient DataSource dataSourceAmov;

	public ReporteCienDepreciadosAmovDaoImpl() {
