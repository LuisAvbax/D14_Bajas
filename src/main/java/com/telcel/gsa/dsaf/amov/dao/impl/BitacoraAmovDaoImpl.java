...
@Repository
public class BitacoraAmovDaoImpl extends AbstractDaoImpl<BajasBitacora, Integer> implements BitacoraAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(BitacoraAmovDaoImpl.class);
	@Autowired
	transient DataSource dataSourceAmov;

	public BitacoraAmovDaoImpl(){
