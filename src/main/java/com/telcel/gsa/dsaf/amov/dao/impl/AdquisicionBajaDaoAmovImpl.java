...
@Repository
public class AdquisicionBajaDaoAmovImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements AdquisicionBajaAmovDao, Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -600814647102535519L;
	final static Logger logger = LoggerFactory.getLogger(AdquisicionBajaDaoAmovImpl.class);
	@Autowired
	...
	public AdquisicionBajaDaoAmovImpl(){
