...
@Repository
public class UsuarioDaoAmovImpl extends AbstractDaoImpl<BajasOpUsuario, Integer> implements UsuarioDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(UsuarioDaoAmovImpl.class);
	@Autowired
