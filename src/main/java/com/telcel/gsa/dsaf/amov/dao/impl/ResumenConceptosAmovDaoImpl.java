...
@Repository
public class ResumenConceptosAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements ResumenConceptosAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(ResumenConceptosAmovDaoImpl.class);
	@Autowired
	...
	public ResumenConceptosAmovDaoImpl(){
