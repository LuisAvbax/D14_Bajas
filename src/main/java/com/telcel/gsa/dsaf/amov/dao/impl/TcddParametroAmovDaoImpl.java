...
@Repository
public class TcddParametroAmovDaoImpl extends AbstractDaoImpl<TcddParametro, String> implements TccddParametroAmovDao, Serializable{

	final static Logger logger = LoggerFactory.getLogger(TcddParametroAmovDaoImpl.class);
	@Autowired
	 ...
	 * 
	 */
	public TcddParametroAmovDaoImpl(){
