...
@Repository
public class InstitucionalAjustesAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements InstitucionalAjustesAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(InstitucionalAjustesAmovDaoImpl.class);
	@Autowired
	...
	public InstitucionalAjustesAmovDaoImpl(){
