...
@Repository
public class TotalGlobalAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements TotalGlobalAmovDao, Serializable{
	 ...
	 * 
	 */
	final static Logger logger = LoggerFactory.getLogger(TotalGlobalAmovDaoImpl.class);
	@Autowired
