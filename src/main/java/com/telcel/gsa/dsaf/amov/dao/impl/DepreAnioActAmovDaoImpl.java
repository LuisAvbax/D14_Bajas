...
@Repository
public class DepreAnioActAmovDaoImpl extends AbstractDaoImpl<v_bajas_nvo3, Integer> implements DepreAnioActAmovDao, Serializable{
	...
	final static Logger logger = LoggerFactory.getLogger(DepreAnioActAmovDaoImpl.class);
	@Autowired
	...
	public DepreAnioActAmovDaoImpl(){
